...
trial_dict = OrderedDict([
                ...
                ('1_H_3', 'HARD_CORR_3'),
                ('1_H_4', 'HARD_CORR_4'),
                ('4_E_3', 'EASY_SMALL_ERROR_3'),
                ('4_E_4', 'EASY_SMALL_ERROR_4'),
                ('3_M_3', 'MEDIUM_SMALL_ERROR_3'),
                ('3_M_4', 'MEDIUM_SMALL_ERROR_4'),                
                ('2_H_3', 'HARD_SMALL_ERROR_3'),
                ('2_H_4', 'HARD_SMALL_ERROR_4'),
                ('5_E_3', 'EASY_BIG_ERROR_3'),
                ('5_E_4', 'EASY_BIG_ERROR_4'),   
                ('4_M_3', 'MEDIUM_BIG_ERROR_3'),
                ('4_M_4', 'MEDIUM_BIG_ERROR_4'),
                ('3_H_3', 'HARD_BIG_ERROR_3'),
                ('3_H_4', 'HARD_BIG_ERROR_4'),
                ('6_E_3', 'EASY_CONTROL_3'),
                ('6_E_4', 'EASY_CONTROL_4'),
                ('6_M_3', 'MEDIUM_CONTROL_3'),
                ('6_M_4', 'MEDIUM_CONTROL_4'),                
                ('6_H_3', 'HARD_CONTROL_3'),
                ('6_H_4', 'HARD_CONTROL_4')])
...
with tqdm(total = len(sacc_files)) as pbar:
    ...
    #%%
        ...
        for name, lab, n in zip(new_names, beh_data['answers'].map({
            ...
            new_name = []
            for item in name:
                new_name.append(str(item) + '_' + str(lab) + '_' + str(n))
            res.append(new_name)
    ...
    #%%      
        ...
        #%%
        grouped_by_n = lambda iterable, n: zip(*(iter(iterable),) * n)
        
        for a,b in grouped_by_n(trial_dict.keys(), 2):
            #print('RV_AVG_DUR_' + trial_dict[a][:-2])
            #print(len(d[a]), len(d[b]), len(d[a] + d[b]))
            part_result['RV_AVG_DUR_' + trial_dict[a][:-2]] = np.nanmean(d[a] + d[b])
        ...
        for a,b in grouped_by_n(trial_dict.keys(), 2):
            #print('RV_AVG_DUR_' + trial_dict[a][:-2])
            #print(len(d[a]), len(d[b]), len(d[a] + d[b]))
            if 'ERROR' in trial_dict[a]:
                part_result['RV_SUM_FIX_' + trial_dict[a][:-2]] = np.nansum(d[a] + d[b]) / 2.0
            else:
                part_result['RV_SUM_FIX_' + trial_dict[a][:-2]] = np.nansum(d[a] + d[b])
  ...
  #%%  
        ...
        w = beh_data.groupby(['rel', 'answers']).mean()
        part_result["MEAN_CORR_EASY_3"] = w['corr'][3][LEVEL.EASY]
        part_result["MEAN_CORR_EASY_4"] = w['corr'][4][LEVEL.EASY]
        part_result["MEAN_CORR_MEDIUM_3"] = w['corr'][3][LEVEL.MEDIUM]
        part_result["MEAN_CORR_MEDIUM_4"] = w['corr'][4][LEVEL.MEDIUM]
        part_result["MEAN_CORR_HARD_3"] = w['corr'][3][LEVEL.HARD]
        part_result["MEAN_CORR_HARD_4"] = w['corr'][4][LEVEL.HARD]
        
        part_result["MEAN_RT_EASY_3"] = w['rt'][3][LEVEL.EASY]
        part_result["MEAN_RT_EASY_4"] = w['rt'][4][LEVEL.EASY]
        part_result["MEAN_RT_MEDIUM_3"] = w['rt'][3][LEVEL.MEDIUM]
        part_result["MEAN_RT_MEDIUM_4"] = w['rt'][4][LEVEL.MEDIUM]
        part_result["MEAN_RT_HARD_3"] = w['rt'][3][LEVEL.HARD]
        part_result["MEAN_RT_HARD_4"] = w['rt'][4][LEVEL.HARD]
        
        #%% percentage of individual oprions in given answers
        ...
        easy = easy.groupby(['rel', 'choosed_option']).count()['ans_accept'] / easy.shape[0]
        medium = medium.groupby(['rel', 'choosed_option']).count()['ans_accept'] / medium.shape[0]
        hard = hard.groupby(['rel', 'choosed_option']).count()['ans_accept'] / hard.shape[0]
        
        part_result['PERC_CORR_EASY_3'] = easy[3].get('D1', 0.0)
        part_result['PERC_CORR_EASY_4'] = easy[4].get('D1', 0.0)
        part_result['PERC_CORR_MEDIUM_3'] = medium[3].get('D1', 0.0)
        part_result['PERC_CORR_MEDIUM_4'] = medium[4].get('D1', 0.0)
        part_result['PERC_CORR_HARD_3'] = hard[3].get('D1', 0.0)
        part_result['PERC_CORR_HARD_4'] = hard[4].get('D1', 0.0)
        
        part_result['PERC_SMALL_ERROR_EASY_3'] = easy[3].get('D4', 0.0)
        part_result['PERC_SMALL_ERROR_EASY_4'] = easy[4].get('D4', 0.0)
        part_result['PERC_SMALL_ERROR_MEDIUM_3'] = medium[3].get('D3', 0.0)
        part_result['PERC_SMALL_ERROR_MEDIUM_4'] = medium[4].get('D3', 0.0)   
        part_result['PERC_SMALL_ERROR_HARD_3'] = hard[3].get('D2', 0.0)
        part_result['PERC_SMALL_ERROR_HARD_4'] = hard[4].get('D2', 0.0)
        
        part_result['PERC_BIG_ERROR_EASY_3'] = easy[3].get('D5', 0.0)
        part_result['PERC_BIG_ERROR_EASY_4'] = easy[4].get('D5', 0.0)
        part_result['PERC_BIG_ERROR_MEDIUM_3'] = medium[3].get('D4', 0.0)
        part_result['PERC_BIG_ERROR_MEDIUM_4'] = medium[4].get('D4', 0.0)
        part_result['PERC_BIG_ERROR_HARD_3'] = hard[3].get('D3', 0.0)
        part_result['PERC_BIG_ERROR_HARD_4'] = hard[4].get('D3', 0.0) 
        
        part_result['PERC_CONTROL_EASY_3'] = easy[3].get('D6', 0.0)
        part_result['PERC_CONTROL_EASY_4'] = easy[4].get('D6', 0.0)
        part_result['PERC_CONTROL_MEDIUM_3'] = medium[3].get('D6', 0.0)
        part_result['PERC_CONTROL_MEDIUM_4'] = medium[4].get('D6', 0.0)
        part_result['PERC_CONTROL_HARD_3'] = hard[3].get('D6', 0.0)
        part_result['PERC_CONTROL_HARD_4'] = hard[4].get('D6', 0.0)
        #%% Relatinal metric
